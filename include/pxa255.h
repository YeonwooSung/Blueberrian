/*****************************************************************************
 *  The header file for the pxa255 stuff that will be used in the ezboot.    *
 *                                                                           *
 *  Almost every contents in this file are from pxa255.h file of the linux.  *
 *****************************************************************************/

#ifndef BLUEBERRIAN_PXA255_H
#define BLUEBERRIAN_PXA255_H

/***************************************
 * Definitions about the default types.*
 ***************************************/
 ...
 */
unsigned long int strtoull(const char *ptr, char **end, int base) {
	unsigned long ret = 0;
