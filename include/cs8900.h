// This file contains the CS8900 routine/
//
// Modified by Yeonwoo Sung on 2018.12.28


#ifndef BLUEBERRIAN_CS8900_HEADER
#define BLUEBERRIAN_CS8900_HEADER
...
#define CS8900_DECTECT_MASK 0x00003000 // CS8900 detect MASK PATTERN
...
//
// Byte interchange for byte alignment compatibility
//
#define SWAP8(A) (A)
...
//
extern BOOL CS8900_Init(void);           // initialise the CS8900 chip
extern Byte *CS8900_GetMacAddress(void); // get the mac address of initialised CS8900 chip
extern BOOL CS8900_CheckLink(void);      // check if the CS8900 is linked to network
...
#endif // BLUEBERRIAN_CS8900_HEADER
